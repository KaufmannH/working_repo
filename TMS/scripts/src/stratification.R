...
plot_gene_set_numbers <- function(df, data_source) {
  ...
  if (data_source == "facs") {
    print("Saved to: FACS.")
    ggsave("facs/plots/3_m/Test_8/strat_bar_gene_sets.png", plot, width = 45, height = 16)
  } else if (data_source == "droplet") {
    print("Saved to: droplet")
    ggsave("droplet/plots/3_m/Test_8/strat_bar_gene_sets.png", plot, width = 45, height = 16)
  } else {
    stop("Issue when saving.")
  }    
}
